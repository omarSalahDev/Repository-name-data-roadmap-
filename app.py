...
# --- Phase 09: Data Career Roadmap ---
    with st.expander("📁 Phase 09: Read: Data Career Roadmap (اضغط للقراءة الكاملة)", expanded=False):
        ...
        <p style="direction: rtl; text-align: right; margin-bottom: 15px;">
            ...
            في الدرس التاسع والأخير من سلسلتنا النظري، جه الوقت نجاوب على السؤال الأهم:<br>
        ...
        <p style="direction: rtl; text-align: right; background: rgba(255, 153, 0, 0.1); padding: 12px; border-radius: 6px; border-right: 4px solid #ff9933; margin-bottom: 0;">
            <b>💡 ختام السلسلة ونقطة انطلاقك:</b> بكده نكون قفلنا "الصورة الكاملة" لرحلة البيانات من الصفر! فهمت المفهوم، الأدوات، طريقة التفكير، والخريطة الوظيفية. جه الوقت دلوقتي لنقل المتابعين من الجانب "النظري" إلى "التطبيق العملي المباشر" وتجهيز البوست المثبت الشامل!
        </p>
